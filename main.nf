...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    nf-core/methylation
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    Github : https://github.com/nf-core/methylation
    Website: https://nf-co.re/methylation
    Slack  : https://nfcore.slack.com/channels/methylation
----------------------------------------------------------------------------------------
*/
...
workflow NFCORE_METHYLATION {
    ...
    emit:
    multiqc_report = METHYLATION.out.multiqc_report // channel: /path/to/multiqc_report.html
...
workflow {
    ...
    PIPELINE_COMPLETION (
        ...
        params.monochrome_logs,
        params.hook_url,
        NFCORE_METHYLATION.out.multiqc_report
    )
}
